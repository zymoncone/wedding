...
const Blog = ({ lang }) => {
  ...
  const PolishContent = () => (
    <>
      <div className="blog-intro">
        Cześć rodzino i przyjaciele! Tu Mayra! Dostałam wiele pytań o to, co robić i zobaczyć w Polsce, a kto jest bardziej kompetentny niż ktoś, kto był w Polsce dwa razy, haha. Rodzice Szymona byli na tyle mili, że pokazali mi wszystko, więc oto moje przemyślenia i nieproszące się rady.
      </div>
      <h2>Gdańsk</h2>
      <p>Każdy, kto słyszał, jak mówię o Polsce, wie, że KOCHAM region Gdańska/Sopotu. Z przyjemnością spędziłabym tu 2-3 pełne dni.</p>
      <img src="https://i.imgur.com/7ggkTXH.png" alt="jedzenie nad Bałtykiem" />
      ...
      <h2>Zakopane</h2>
      <p>Miłośnicy natury! To także świetne miejsce na ucieczkę i relaks.</p>
      <img src="https://i.imgur.com/g06p44P.png" alt="para na skale w Tatrach" />
      ...
      <img src="https://i.imgur.com/lpuacKB.png" alt="Dżemy na targu na szczycie Tatr" />
      <h2>Kraków</h2>
      <p>Miłośnicy miast!</p>
      <h3>Dzień 1:</h3>
      <p>
