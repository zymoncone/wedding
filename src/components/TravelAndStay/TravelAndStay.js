...
import { useAppContext } from "../PolandNav/PolandRoot";
      ...
      <div className="travel-and-stay-content">
        ...
        <div className="blog-container">
          <div className="blog-background-container">
            <div className="blog-background-image" style={{
          ...
          <div className="blog-text-body">
            ...
            <img src="https://i.imgur.com/g8Cya5b.png" alt="sad girl hiking" className="left-image" />
            <p>
