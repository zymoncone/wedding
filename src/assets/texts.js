...
export const whatsapp_button = {
  ...
  "PL": "Dołącz do naszej grupy WhatsApp",
  "SP": ""
};
...
export const travel_directions_text = {
  "EN": "Fly into Warsaw",
  "PL": "Przyleć do Warszawy",
  "SP": ""
};

export const travel_directions_text_2 = {
  "EN": "Fly into Kraków",
  "PL": "Przyleć do Krakowa",
  "SP": ""
};
...
export const travel_directions_text_body_part_1 = {
  ...
  "PL": "Często bardziej opłaca się przylecieć na lotnisko Chopina. Stamtąd można wziąć pociąg dużych prędkości z ",
  "SP": ""
};
...
export const stay_text = {
  ...
  "PL": "Zarezerwowaliśmy pokoje dla naszych gości w Hotelu Novum, który znajduje się zaledwie 500 metrów od zamku dla Waszej wygody.",
  "SP": ""
};
...
export const rsvp_thank_you_top = {
  ...
  "PL": "Dziękujemy za potwierdzenie przybycia!",
  "SP": ""
};
...
export const rsvp_is_attending = {
  "EN": " is marked as attending.",
  "PL": " został zgłoszony jako obecny.",
  "SP": ""
};

export const rsvp_is_not_attending = {
...
export const rsvp_courtesy_text = {
  ...
  "PL": "Zachęcamy do zaktualizowania poniższych informacji.",
  "SP": ""
};
...
export const song_request_text = {
  "EN": "Song Request",
  "PL": "Prośba o Piosenkę",
  "SP": ""
};
...
export const our_story_paragraph_1 = {
  ...
  "PL": "Mayra i Szymon poznali się dzięki lidze siatkówki i – jakimś cudem – trafili do tej samej drużyny. Pomimo niesfornych włosów Szymona (ci, którzy wiedzą, ten wiedzą), Mayra od razu była pod wrażeniem jego umiejętności siatkarskich. Kilka miesięcy później, gdy Mayra była pochłonięta swoją fazą majsterkowania, Szymon postanowił jej pomóc w budowie szafki pod telewizor. Sprawiał wrażenie, że ma wszystkie potrzebne narzędzia, choć w rzeczywistości kupił je specjalnie na tę okazję w Home Depot. Wspólna praca nad projektem bardzo ich do siebie zbliżyła – a reszta to już historia.",
...
export const our_story_paragraph_2 = {
  ...
  "PL": "W kwietniu następnego roku Szymon kupił dom, do którego wprowadziły się zarówno Luna, jak i Mayra. W trójkę wspólnie wyruszyli do Chicago, a następnie osiedlili się w Jersey City.",
...
export const our_story_paragraph_3 = {
  ...
  "PL": "Mayra mówi, że jedną z rzeczy, które najbardziej ceni w Szymonie, jest to, jak wspaniałym jest partnerem – zarówno w domu, jak i w życiu. Wypracowali niewerbalny sposób rozpoznawania nawzajem swoich obciążeń i ułatwiania sobie codzienności – bez potrzeby zadawania pytań.",
...
export const our_story_paragraph_4 = {
  ...
  "PL": "Szymon uważa Mayrę za jedną z najbardziej troskliwych osób, jakie kiedykolwiek poznał. Zawsze stawia jego i swoich bliskich na pierwszym miejscu, uważnie słucha i zapamiętuje najdrobniejsze szczegóły. Trudno ją pokonać w konkursie na najlepszy prezent.",
...
export const our_story_paragraph_5 = {
  ...
  "PL": "Oboje z radością rozpoczynają nowy rozdział wspólnego życia i są ciekawi, dokąd zaprowadzi ich przyszłość.",
...
const poland_faq_polish = [
  ...
  {
    question: "Czy zapewniony jest transport na miejsce uroczystości i z powrotem?",
  ...
  {
    question: "Czy mogę przyprowadzić dodatkowego gościa lub dziecko, które nie zostało uwzględnione w zaproszeniu?",
